...
ma_data=pd.read_csv('Ordered_Magazine_Subscriptions.csv',names=['productId','userID','Rating','timestamp'])
print(ma_data.head())
...
mag = DataProcess('Ordered_Magazine_Subscriptions.csv')
...
ndf2.to_csv('ml-1m.test.negative.csv',header=None, index=None)